...
export const Button = ({ onClick, onConfirm, confirmText, color, marginBottom, disabled, children }) => {
  ...
  const btnClass = classNames({
    ...
    'bg-gray-600 hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-800': disabled && !color,
    'bg-yellow-600 hover:bg-yellow-700 focus:bg-yellow-700 active:bg-yellow-800': !disabled && confirm,
    'bg-green-600 hover:bg-green-700 focus:bg-green-700 active:bg-green-800': color === 'green',
    'bg-red-600 hover:bg-red-700 focus:bg-red-700 active:bg-red-800': color === 'red',
    'mt-1': true,
    'mb-2': marginBottom,
  });
