...
// Filter rewards table and return potential reward results based on roll selected
export const getPotentialRewardResults = (table, roll) =>
  table.filter((obj) => obj.roll === roll).map((obj) => obj.results)[0];
